...
const Products = () => {
    ...
    return (
        <div className="mx-5 md:mx-14 lg:mx-20 py-7 my-5 text-[#2A2523]">
            ...
            <div className="mt-10">
                <div className="flex flex-row overflow-x-scroll gap-6 ">
                ...
                group hover:shadow-lg overflow-hidden transition-all duration-500 ease-in-out`}
                        >
